      ...
      <View style={styles.container}>
        <View
          ...
          <View style={styles.recordingContainer}>
            ...
            <View style={styles.recordingDataContainer}>
              <View />
              <Text style={[styles.liveText, { fontFamily: 'roboto' }]}>
              ...
              <View style={styles.recordingDataRowContainer}>
                ...
                />
                <Text style={[styles.recordingTimestamp, { fontFamily: 'roboto' }]}>
        ...
        <View
          ...
          <View style={styles.playbackContainer}>
            ...
            />
            <Text style={[styles.playbackTimestamp, { fontFamily: 'roboto' }]}>
          ...
          <View style={[styles.buttonsContainerBase, styles.buttonsContainerBottomRow]}>
            <Text style={[styles.timestamp, { fontFamily: 'roboto' }]}>Rate:</Text>
            <Slider
